...
.data
    ...
    fname_invalid_msg db "Invalid name. Please enter only alphabetical characters.", 13, 10, 0
    id_invalid_msg    db "Invalid ID. Please enter exactly 6 numeric digits.", 13, 10, 0
